...
-(void)addPercentageLabel:(CGFloat)percentage{
    ...
    [_percentLabel setCenter:CGPointMake(self.bounds.size.width/2,self.bounds.size.height/2)];
    [_percentLabel setBackgroundColor:[UIColor clearColor]];
    [_percentLabel setTextColor:[UIColor blackColor]];
    [_percentLabel setFont:[UIFont fontWithName:@"Futura-Medium" size:32]];
...
-(UIColor *)progressBackgroundColor{
    ...
    if (!_progressBackgroundColor) {
        _progressBackgroundColor= [UIColor colorWithRed:0.86f green:0.86f blue:0.86f alpha:1.00f];
